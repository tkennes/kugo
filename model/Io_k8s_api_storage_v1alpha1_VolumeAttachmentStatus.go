...
type Io_k8s_api_storage_v1alpha1_VolumeAttachmentStatus struct {
	...
	// See: file:///Users/tomkennes/Clients/Volksbank/code/custom/kugo/model/Io_k8s_api_storage_v1alpha1_VolumeError.go
	AttachError        *Io_k8s_api_storage_v1alpha1_VolumeError `json:"attachError,omitempty"`
	...
	// See: file:///Users/tomkennes/Clients/Volksbank/code/custom/kugo/model/Io_k8s_api_storage_v1alpha1_VolumeError.go
	DetachError        *Io_k8s_api_storage_v1alpha1_VolumeError `json:"detachError,omitempty"`
}
