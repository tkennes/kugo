...
// drivers do not need to create the CSIDriver object directly. Instead they may use the cluster-driver-registrar sidecar
// container. When deployed with a CSI driver it automatically creates a CSIDriver object representing the driver.
...
type Io_k8s_api_storage_v1beta1_CSIDriver struct {
	...
	// See: file:///Users/tomkennes/Clients/Volksbank/code/custom/kugo/model/Io_k8s_api_storage_v1beta1_CSIDriverSpec.go
	Spec       Io_k8s_api_storage_v1beta1_CSIDriverSpec         `json:"spec"`
}
