...
type Io_k8s_api_rbac_v1_RoleList struct {
	...
	// See: file:///Users/tomkennes/Clients/Volksbank/code/custom/kugo/model/Io_k8s_api_rbac_v1_Role.go
	Items      []Io_k8s_api_rbac_v1_Role                      `json:"items"`
