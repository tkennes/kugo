...
type Io_k8s_api_rbac_v1alpha1_ClusterRoleList struct {
	...
	// See: file:///Users/tomkennes/Clients/Volksbank/code/custom/kugo/model/Io_k8s_api_rbac_v1alpha1_ClusterRole.go
	Items      []Io_k8s_api_rbac_v1alpha1_ClusterRole         `json:"items"`
