...
type Io_k8s_api_authorization_v1beta1_SelfSubjectRulesReview struct {
	...
	// See: file:///Users/tomkennes/Clients/Volksbank/code/custom/kugo/model/Io_k8s_api_authorization_v1beta1_SelfSubjectRulesReviewSpec.go
	Spec       Io_k8s_api_authorization_v1beta1_SelfSubjectRulesReviewSpec `json:"spec"`

	// Status is filled in by the server and indicates the set of actions a user can perform.
	// See: file:///Users/tomkennes/Clients/Volksbank/code/custom/kugo/model/Io_k8s_api_authorization_v1beta1_SubjectRulesReviewStatus.go
	Status     *Io_k8s_api_authorization_v1beta1_SubjectRulesReviewStatus  `json:"status,omitempty"`
}
