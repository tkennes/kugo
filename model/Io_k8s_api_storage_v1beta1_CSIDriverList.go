...
type Io_k8s_api_storage_v1beta1_CSIDriverList struct {
	...
	// See: file:///Users/tomkennes/Clients/Volksbank/code/custom/kugo/model/Io_k8s_api_storage_v1beta1_CSIDriver.go
	Items      []Io_k8s_api_storage_v1beta1_CSIDriver         `json:"items"`
