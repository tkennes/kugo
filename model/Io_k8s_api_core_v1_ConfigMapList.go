...
type Io_k8s_api_core_v1_ConfigMapList struct {
	...
	// See: file:///Users/tomkennes/Clients/Volksbank/code/custom/kugo/model/Io_k8s_api_core_v1_ConfigMap.go
	Items      []Io_k8s_api_core_v1_ConfigMap                 `json:"items"`
