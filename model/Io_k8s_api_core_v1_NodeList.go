...
type Io_k8s_api_core_v1_NodeList struct {
	...
	// List of nodes
	// See: file:///Users/tomkennes/Clients/Volksbank/code/custom/kugo/model/Io_k8s_api_core_v1_Node.go
	Items      []Io_k8s_api_core_v1_Node                      `json:"items"`
