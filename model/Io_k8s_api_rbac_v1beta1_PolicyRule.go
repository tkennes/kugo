...
type Io_k8s_api_rbac_v1beta1_PolicyRule struct {
	...
	// Resources is a list of resources this rule applies to.  '*' represents all resources in the specified apiGroups. '*/foo'
	// represents the subresource 'foo' for all resources in the specified apiGroups.
	// See: file:///Users/tomkennes/Documents/Clients/_generic/kugo/model/string.go
