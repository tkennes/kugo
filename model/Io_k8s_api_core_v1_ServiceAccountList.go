...
type Io_k8s_api_core_v1_ServiceAccountList struct {
	...
	// See: file:///Users/tomkennes/Clients/Volksbank/code/custom/kugo/model/Io_k8s_api_core_v1_ServiceAccount.go
	Items      []Io_k8s_api_core_v1_ServiceAccount            `json:"items"`
