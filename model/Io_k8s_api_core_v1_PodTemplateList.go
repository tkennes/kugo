...
type Io_k8s_api_core_v1_PodTemplateList struct {
	...
	// See: file:///Users/tomkennes/Clients/Volksbank/code/custom/kugo/model/Io_k8s_api_core_v1_PodTemplate.go
	Items      []Io_k8s_api_core_v1_PodTemplate               `json:"items"`
