...
// RoleBindings in a given namespace only have effect in that namespace. Deprecated in v1.17 in favor of
// rbac.authorization.k8s.io/v1 RoleBinding, and will no longer be served in v1.22.
type Io_k8s_api_rbac_v1alpha1_RoleBinding struct {
	...
	// See: file:///Users/tomkennes/Clients/Volksbank/code/custom/kugo/model/Io_k8s_api_rbac_v1alpha1_RoleRef.go
	RoleRef    Io_k8s_api_rbac_v1alpha1_RoleRef                 `json:"roleRef"`

	// Subjects holds references to the objects the role applies to.
	// See: file:///Users/tomkennes/Clients/Volksbank/code/custom/kugo/model/Io_k8s_api_rbac_v1alpha1_Subject.go
