...
type Io_k8s_api_networking_v1beta1_IngressList struct {
	...
	// See: file:///Users/tomkennes/Clients/Volksbank/code/custom/kugo/model/Io_k8s_api_networking_v1beta1_Ingress.go
	Items      []Io_k8s_api_networking_v1beta1_Ingress        `json:"items"`
