...
type Io_k8s_api_rbac_v1beta1_RoleBindingList struct {
	...
	// See: file:///Users/tomkennes/Clients/Volksbank/code/custom/kugo/model/Io_k8s_api_rbac_v1beta1_RoleBinding.go
	Items      []Io_k8s_api_rbac_v1beta1_RoleBinding          `json:"items"`
