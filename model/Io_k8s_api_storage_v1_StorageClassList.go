...
type Io_k8s_api_storage_v1_StorageClassList struct {
	...
	// See: file:///Users/tomkennes/Clients/Volksbank/code/custom/kugo/model/Io_k8s_api_storage_v1_StorageClass.go
	Items      []Io_k8s_api_storage_v1_StorageClass           `json:"items"`
