...
type Io_k8s_api_batch_v2alpha1_CronJobList struct {
	...
	// See: file:///Users/tomkennes/Clients/Volksbank/code/custom/kugo/model/Io_k8s_api_batch_v2alpha1_CronJob.go
	Items      []Io_k8s_api_batch_v2alpha1_CronJob            `json:"items"`
