...
type Io_k8s_api_node_v1_RuntimeClassList struct {
	...
	// See: file:///Users/tomkennes/Clients/Volksbank/code/custom/kugo/model/Io_k8s_api_node_v1_RuntimeClass.go
	Items      []Io_k8s_api_node_v1_RuntimeClass              `json:"items"`
