...
type Io_k8s_api_core_v1_ServiceList struct {
	...
	// List of services
	// See: file:///Users/tomkennes/Clients/Volksbank/code/custom/kugo/model/Io_k8s_api_core_v1_Service.go
	Items      []Io_k8s_api_core_v1_Service                   `json:"items"`
