...
type Io_k8s_api_storage_v1_CSIDriverSpec struct {
	...
	// defined by a CSIVolumeSource, otherwise "false"  "csi.storage.k8s.io/ephemeral" is a new feature in Kubernetes 1.16. It
	// is only required for drivers which support both the "Persistent" and "Ephemeral" VolumeLifecycleMode. Other drivers can
	...
	// parse and validate the following VolumeContext: "csi.storage.k8s.io/serviceAccount.tokens": {   "<audience>": {
	// "token": <token>,     "expirationTimestamp": <expiration timestamp in RFC3339>,   },   ... }  Note: Audience in each
	...
	// See: file:///Users/tomkennes/Documents/Clients/_generic/kugo/model/Io_k8s_api_storage_v1_TokenRequest.go
	TokenRequests        []Io_k8s_api_storage_v1_TokenRequest `json:"tokenRequests,omitempty"`
