...
// Tree Depth: 4
// REFERENCES:
// - file:///Users/tomkennes/Documents/Clients/_generic/kugo/model/Io_k8s_api_flowcontrol_v1alpha1_LimitedPriorityLevelConfiguration.go


// LimitResponse defines how to handle requests that can not be executed right now.
type Io_k8s_api_flowcontrol_v1alpha1_LimitResponse struct {
	// `queuing` holds the configuration parameters for queuing. This field may be non-empty only if `type` is `"Queue"`.
	// See: file:///Users/tomkennes/Documents/Clients/_generic/kugo/model/Io_k8s_api_flowcontrol_v1alpha1_QueuingConfiguration.go
