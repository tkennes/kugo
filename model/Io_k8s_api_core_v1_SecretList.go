...
type Io_k8s_api_core_v1_SecretList struct {
	...
	// See: file:///Users/tomkennes/Clients/Volksbank/code/custom/kugo/model/Io_k8s_api_core_v1_Secret.go
	Items      []Io_k8s_api_core_v1_Secret                    `json:"items"`
